...
class ReconstructionN : public reconstruction::Reconstruction {    
public:
    ReconstructionN(reconstruction::dataset::Parameters *parameters) : reconstruction::Reconstruction(parameters)
    {
